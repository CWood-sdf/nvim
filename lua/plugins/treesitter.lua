return {
	...
	config = function()
		...
		vim.keymap.set({ "n", "x", "o" }, "[f", function()
			tom.goto_previous_start("@function.outer", "textobjects")
		end, { desc = "previousious function" })
		vim.keymap.set({ "n", "x", "o" }, "[c", function()
			tom.goto_previous_start("@class.outer", "textobjects")
		end, { desc = "previousious class" })
		vim.keymap.set({ "n", "x", "o" }, "[l", function()
			tom.goto_previous_start({ "@loop.outer", "@loop.outer" }, "textobjects")
		end, { desc = "previousious loop" })
		vim.keymap.set({ "n", "x", "o" }, "[s", function()
			tom.goto_previous_start("@scope", "locals")
		end, { desc = "previousious scope" })
		vim.keymap.set({ "n", "x", "o" }, "[z", function()
			tom.goto_previous_start("@fold", "folds")
		end, { desc = "previousious fold" })
		vim.keymap.set({ "n", "x", "o" }, "[i", function()
			tom.goto_previous_start("@conditional.outer", "textobjects")
		end, { desc = "previousious conditional" })

		vim.keymap.set({ "n", "x", "o" }, "[F", function()
			tom.goto_previous_end("@function.inner", "textobjects")
		end, { desc = "previousious function" })
		vim.keymap.set({ "n", "x", "o" }, "[C", function()
			tom.goto_previous_end("@class.inner", "textobjects")
		end, { desc = "previousious class" })
		vim.keymap.set({ "n", "x", "o" }, "[L", function()
			tom.goto_previous_end({ "@loop.inner", "@loop.inner" }, "textobjects")
		end, { desc = "previousious loop" })
		vim.keymap.set({ "n", "x", "o" }, "[S", function()
			tom.goto_previous_end("@scope", "locals")
		end, { desc = "previousious scope" })
		vim.keymap.set({ "n", "x", "o" }, "[Z", function()
			tom.goto_previous_end("@fold", "folds")
		end, { desc = "previousious fold" })
		vim.keymap.set({ "n", "x", "o" }, "[I", function()
			tom.goto_previous_end("@conditional.inner", "textobjects")
		end, { desc = "previousious conditional" })
