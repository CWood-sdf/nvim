...
lsp.on_attach(function(client, bufnr)
    ...
    wk.remapNoGroup("n", "[d", "Next diagnostic", function() vim.diagnostic.goto_next() end, opts)
    wk.remapNoGroup("n", "]d", "Previous diagnostic", function() vim.diagnostic.goto_prev() end, opts)
    wk.remapNoGroup("n", "<C-h>", "Signature help", function() vim.lsp.buf.signature_help() end, opts)
    wk.writeBuf()
end)
lsp.setup()
